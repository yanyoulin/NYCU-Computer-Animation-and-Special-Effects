...
bool inverseJacobianIKSolver(const Eigen::Vector4d& target_pos, const Eigen::Vector4d& obs_pos, bool obsActive, acclaim::Bone* start_bone, acclaim::Bone* end_bone,
