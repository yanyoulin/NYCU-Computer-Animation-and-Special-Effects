...
bool Motion::inverseKinematics(const Eigen::Vector4d &target, const Eigen::Vector4d &obs, bool obsActive, int start, int end) {
    bool result = kinematics::inverseJacobianIKSolver(target, obs, obsActive, skeleton->getBonePointer(start),
